        ...
        <div className="container mx-auto px-4 max-w-7xl h-full flex items-center">
          <div className="max-w-xl text-white relative z-10 md:text-left text-center">
            ...
            <div className="md:flex md:space-y-0 space-y-2 md:space-x-4">
              <a href="/apartments" className="block cursor-pointer md:w-auto w-full bg-accent hover:bg-accent/90 text-white px-6 sm:py-3 py-4 font-medium !rounded-button whitespace-nowrap">Browse Apartments</a>
              <a href="/aboutus" className="block cursor-pointer md:w-auto w-full bg-white hover:bg-gray-100 text-primary px-6 sm:py-3 py-4 font-medium !rounded-button whitespace-nowrap">About Us</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col md:flex-row items-center justify-between text-white bg-primary rounded-lg shadow-md overflow-hidden">
            <div className="p-8 md:p-12 md:w-1/2 ">
              ...
              <div className="flex flex-wrap sm:gap-4 mb-8">
                <div className="flex flex-col grow items-center justify-center rounded-lg p-3 w-20 h-20">
                  <span className="sm:text-2xl font-bold">12</span>
                  <span className="text-xs">Days</span>
                </div>
                <div className="flex flex-col grow items-center justify-center rounded-lg p-3 w-20 h-20">
                  <span className="sm:text-2xl font-bold">08</span>
                  <span className="text-xs">Hours</span>
                </div>
                <div className="flex flex-col grow items-center justify-center rounded-lg p-3 w-20 h-20">
                  <span className="sm:text-2xl font-bold">45</span>
                  <span className="text-xs">Minutes</span>
                </div>
                <div className="flex flex-col grow items-center justify-center rounded-lg p-3 w-20 h-20">
                  <span className="sm:text-2xl font-bold">22</span>
                  <span className="text-xs">Seconds</span>
                </div>
              </div>
              <div className="sm:flex sm:space-x-4 sm:space-y-0 space-y-4">
                <button
                  className="bg-accent block w-full hover:bg-accent/90 text-white px-6 py-3 font-medium !rounded-button whitespace-nowrap">View
                  Specials</button>
                <button
                  className="bg-white border block w-full border-gray-300 hover:border-accent text-gray-800 hover:text-accent px-6 py-3 font-medium !rounded-button whitespace-nowrap">Contact
                  Manager</button>
              </div>
            </div>
