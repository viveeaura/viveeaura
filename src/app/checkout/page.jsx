    ...
    <section className="pt-28">
      ...
      <main class="container mx-auto px-4 py-8 max-w-7xl">
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="lg:w-2/3">
            <h2 class="text-2xl heading-font font-bold mb-6">Complete Your Booking</h2>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
              <div class="flex flex-col sm:flex-row gap-6">
                ...
                <div class="w-full sm:w-2/3">
                  <h3 class="text-xl heading-font font-bold mb-2">Luxury Soho Loft</h3>
                  ...
                  <button class="text-accent font-medium text-sm flex items-center">
                    <i class="ri-pencil-line mr-1"></i> Edit booking details
                  </button>
                </div>
              </div>
            </div>
            ...
            {/* <!-- Guest Information --> */}
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
              <h3 class="text-xl heading-font font-bold mb-6">Guest Information</h3>
              ...
              <form>
                ...
                <div class="flex items-center mb-6">
                  ...
                  <label for="create-account" class="text-sm text-gray-700">Create an UrbanStay account for faster booking next time</label>
                </div>
              </form>
            </div>
            ...
            {/* <!-- Payment Method --> */}
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
              <h3 class="text-xl heading-font font-bold mb-6">Payment Method</h3>

              <div class="space-y-4 mb-6">
                {/* <!-- Credit Card --> */}
                <div class="payment-method selected p-4 border-2 border-accent rounded-lg cursor-pointer bg-pale">
                  <div class="flex items-center">
                    <div class="w-10 h-10 flex items-center justify-center bg-white rounded-full mr-4 shadow-sm">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
              <h3 class="text-xl heading-font font-bold mb-4">Terms and Conditions</h3>
          ...
          <div class="lg:w-1/3">
            <div class="bg-white rounded-xl shadow-md sticky top-6 p-6">
              <h3 class="text-xl heading-font font-bold mb-6">Booking Summary</h3>
